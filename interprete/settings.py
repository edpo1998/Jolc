"""
Django settings for interprete project.
...
SECRET_KEY = 'django-insecure-4m!^$7zr==d5d##!uw_(vs2i7_xrwz7=)=)0mhyx$-+##6e%=8'
...
WSGI_APPLICATION = 'interprete.wsgi.application'
